...
<?php 
	...
	$query = $pdo->query("SELECT * from colaboradores ORDER BY (nome) ASC LIMIT $inicio, $limite_resultado");
...
<!-- Content wrapper -->
 <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Colaboradores /</span> Gerenciar Colaboradores</h4>

              <!-- Basic Bootstrap Table -->
              <div class="card">
                <h5 class="card-header">Gerenciar Colaboradores</h5>
            ...
            $id = $res[$i]['id'];
						$nome = $res[$i]['nome'];
                        $status_id = $res[$i]['ativo'];

						?>
                      <tr>
                        <td><?php
              
						$query_2 = $pdo->query("SELECT * from bicicletas where colaborador_id = '$id'");
						$res_2 = $query_2->fetchAll(PDO::FETCH_ASSOC);
						$numero = $res_2[0]['numero'];
            ?> 
